namespace RDPERP.POS.Desktop.Extensions
{
    using System;
    ...
    namespace SqliteORM.Extensions
    {
        ...
        public class SqliteExtensions : IDisposable
        {
            ...
            public SqliteExtensions(SQLiteConnection connection)
            {
            ...
            public SqliteExtensions(string connectionString)
            {
                this.CloseAndDisploseDataReader = _defaultCloseAndDisploseDataReader;
                this.BatchSize = _defaultBatchSize;
                this.BulkCopyTimeout = _defaultCopyTimeout;
